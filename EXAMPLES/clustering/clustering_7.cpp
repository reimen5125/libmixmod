/***************************************************************************
                             EXAMPLES/clustering/clustering_7.cpp  description
...
void clustering_7_example() {
    ...
    cout<<"  - strategy initialisation : SEM_MAX"<<endl;
    cout<<"     - nbIterationInInit = 100"<<endl;
    cout<<"-----------------------------------------------------------------------"<<endl<<endl;
    ...
    cInput->getStrategy()->setStrategyInitName ( XEM::SEM_MAX );
    cInput->getStrategy()->setNbIterationInInit ( 100 );
